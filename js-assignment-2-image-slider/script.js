function imageCarousel(width, height, transitionTime, holdTime, index) {
  ...
  this.init = function () {
    ...
    this.autoSlide = setInterval(rightSlide.bind(this), (this.transitionTime + this.holdTime * 1000));
  }
...
var carousel1 = new imageCarousel(800, 500, 10, 3, 0);
carousel1.init();

var carousel2 = new imageCarousel(400, 400, 5, 4, 1);
carousel2.init();

var carousel3 = new imageCarousel(650, 600, 20, 5, 2);
carousel3.init();